          ...
          >
            <div className="w-full max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row gap-10 py-10 items-start">
                <div className="w-full flex justify-center mb-8 lg:mb-0">
                  <video
                    src="/DRA MARIA ALICE - EDITADO.mp4"
                    autoPlay
                    muted
                    loop
                    controls
                ...
                <div className="flex flex-col w-full text-black">
                  <ul className="pl-0 mt-4 space-y-4 text-base h-full ">
                    <li className="flex items-center gap-2 border-b border-gray-200 pb-2 transition-colors duration-200 hover:text-blue-400 group cursor-pointer">
                      ...
                      <span className="text-black group-hover:text-blue-400 transition-colors duration-200">
            ...
            <div className="flex flex-col items-center py-10 sm:py-16 w-full max-w-7xl mx-auto">
              <InlineEditor
                ...
                onSave={(value) =>
                  handleSaveContent("tituloTratamentos", value)
                }
              ...
              <InlineEditor
                ...
                initialValue={
                  content.subtituloTratamentos ||
                  "MEDICINA FUNCIONAL INTEGRATIVA – Diagnóstico e Tratamento"
                }
                onSave={(value) =>
                  handleSaveContent("subtituloTratamentos", value)
                }
              ...
              <div className="flex flex-col md:flex-row gap-6 w-full max-w-5xl justify-center items-center">
                <div className="relative bg-white rounded-2xl rounded-l-none border border-[#000000] shadow-[0_4px_24px_0_rgba(44,51,73,0.04)] flex flex-col items-start px-4 sm:px-6 pt-6 pb-5 w-full max-w-xs sm:max-w-sm md:w-[340px] min-h-[420px] transition-shadow hover:shadow-lg">
                  <ImageEditor
                    ...
                    initialValue={
                      content.imagemOrtomolecular ||
                      "/pratica-ortomolecular.jpg"
                    }
                    onSave={handleSaveContent}
                  ...
                  <InlineEditor
                    ...
                    onSave={(value) =>
                      handleSaveContent("tituloOrtomolecular", value)
                    }
                  ...
                  <InlineEditor
                    ...
                    initialValue={
                      content.descricaoOrtomolecular ||
                    ...
                    onSave={(value) =>
                      handleSaveContent("descricaoOrtomolecular", value)
                    }
                    type="textarea"
                  ...
                  <button
                    onClick={() => router.push("/partica-ortomolecular")}
                    className="text-[#3366FF] text-xs font-semibold mt-auto hover:underline transition-colors"
                  >
                    Saiba Mais →
                  </button>
                </div>
                <div className="relative bg-white rounded-2xl rounded-l-none border border-[#000000] shadow-[0_4px_24px_0_rgba(44,51,73,0.04)] flex flex-col items-start px-4 sm:px-6 pt-6 pb-5 w-full max-w-xs sm:max-w-sm md:w-[340px] min-h-[420px] transition-shadow hover:shadow-lg">
                  <ImageEditor
                    ...
                    initialValue={
                      content.imagemEmagrecimento ||
                      "/tratamento-emagrecimento.jpg"
                    }
                    onSave={handleSaveContent}
                    className="w-full h-44 object-cover rounded-xl mb-6"
                    alt="Emagrecimento"
                  ...
                  <InlineEditor
                    ...
                    onSave={(value) =>
                      handleSaveContent("tituloEmagrecimento", value)
                    }
                    className="font-bold text-[15px] text-[#222B45] mb-2 uppercase tracking-tight"
                  >
                    {content.tituloEmagrecimento || "EMAGRECIMENTO"}
                  ...
                  <InlineEditor
                    ...
                    initialValue={
                      content.descricaoEmagrecimento ||
                    ...
                    onSave={(value) =>
                      handleSaveContent("descricaoEmagrecimento", value)
                    }
                    type="textarea"
                    className="text-[13px] text-[#8F9BB3] mb-6 leading-relaxed"
                  >
                  ...
                  <button
                    onClick={() => router.push("/emagrecimento")}
                    className="text-[#3366FF] text-xs font-semibold mt-auto hover:underline transition-colors"
                  >
                    Saiba Mais →
                  </button>
                ...
                <div className="relative bg-white rounded-2xl rounded-l-none border border-[#000000] shadow-[0_4px_24px_0_rgba(44,51,73,0.04)] flex flex-col items-start px-4 sm:px-6 pt-6 pb-5 w-full max-w-xs sm:max-w-sm md:w-[340px] min-h-[420px] transition-shadow hover:shadow-lg">
                  <ImageEditor
                    ...
                    initialValue={
                      content.imagemModulacao || "/ortomolecular.png"
                    }
                    onSave={handleSaveContent}
                    className="w-full h-44 object-cover rounded-xl mb-6"
                  ...
                  <InlineEditor
                    ...
                    onSave={(value) =>
                      handleSaveContent("tituloModulacao", value)
                    }
                    className="font-bold text-[15px] text-[#222B45] mb-2 uppercase tracking-tight"
                  >
                    {content.tituloModulacao || "MODULAÇÃO HORMONAL"}
                  ...
                  <InlineEditor
                    ...
                    onSave={(value) =>
                      handleSaveContent("descricaoModulacao", value)
                    }
                    type="textarea"
                    className="text-[13px] text-[#8F9BB3] mb-6 leading-relaxed"
                  >
                  ...
                  <button
                    onClick={() => router.push("/modulacao-hormonal")}
                    className="text-[#3366FF] text-xs font-semibold mt-auto hover:underline transition-colors"
                  >
                    Saiba Mais →
                  </button>
          ...
          <section className="w-full bg-[#86D6FB] py-10 md:px-[18%] flex flex-col items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center">
              <InlineEditor
                ...
                onSave={(value) =>
                  handleSaveContent("tituloAgendamento", value)
                }
              ...
              <InlineEditor
                ...
                onSave={(value) =>
                  handleSaveContent("descricaoAgendamento", value)
                }
                type="textarea"
